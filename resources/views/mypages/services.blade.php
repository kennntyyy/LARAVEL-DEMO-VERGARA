...
<body>
    <h1
        ...
        This is <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Services</mark> /KPV.</h1>
    <br>
    <a href="{{route('index')}}">
    <button type="button"
    ...
    <a href="{{route('services')}}">
        <button type="button"
            ...
            <svg aria-hidden="true" class="w-6 h-5 me-2 -ms-1" viewBox="0 0 2405 2501" fill="none"
